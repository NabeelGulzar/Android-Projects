...
public class itemsANFYSmActivity extends baseactivity {

    private List<ItemCategoryMenu> items;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_items_anfysm);
        items=new ArrayList<>();
        items.add(new ItemCategoryMenu(R.mipmap.food,"Berry Passion"));
        items.add(new ItemCategoryMenu(R.mipmap.food,"Strawberry Banana"));
        items.add(new ItemCategoryMenu(R.mipmap.food,"Clementine Mango"));
        ...
        ListView subCategoryList = (ListView)findViewById(R.id.itemsANFYSmList);
                ...
                (
                        new AdapterView.OnItemClickListener(){
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                Toast.makeText(itemsANFYSmActivity.this, category.getText(), Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(view.getContext(),detailActivity.class);
                                intent.putExtra("name",category.getText());
                                intent.putExtra("cat","Smoothies");
