...
public class itemsCDLActivity extends baseactivity {
    private List<ItemCategoryMenu> items;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_items_cdl);
        items=new ArrayList<>();
        items.add(new ItemCategoryMenu(R.mipmap.food,"Marble Loaf"));
        items.add(new ItemCategoryMenu(R.mipmap.food,"Banana Loaf"));
        ...
        ListView subCategoryList = (ListView)findViewById(R.id.itemsCDLList);
        ...
        subCategoryList.setOnItemClickListener(
                new AdapterView.OnItemClickListener(){
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Toast.makeText(itemsCDLActivity.this, category.getText(), Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(view.getContext(),detailActivity.class);
                        intent.putExtra("name",category.getText());
                        intent.putExtra("cat","Loaves");
